...
2. **The database blocker is resolved.** `tools/etl/build_fact.py` builds
   ...
   **Backend hosting is decided (Option A) and done** — both halves are live. Full current
   status: [03 §9](03-infrastructure-decision.md#9-current-deployment-status-as-of-2026-08-25).
